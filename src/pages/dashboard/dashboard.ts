...
export class DashboardPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public BuilderService: PollBuilderServiceProvider, public http: HttpClient, public dash$: DashboardServiceProvider) {
